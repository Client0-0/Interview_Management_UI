...
export function buildBackendPayload(
  ...
  return {
    ...
    feedbackSettings: {
      overallRatingRequired: feedback.overallRating,
      technicalSkillRequired: feedback.technicalSkills,
      communicationRequired: feedback.communication,
      problemSolvingRequired: feedback.ProblemSolving,
      recommendationRequired: feedback.recommendation,
      overallFeedbackRequired: feedback.Feedback,
    },
  };
}
